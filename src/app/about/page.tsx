...
export default function About() {
	const libraries = [
		...
		{
			icon: '/about/shadcn.png',
			title: 'Shadcn/ui',
			link: 'https://ui.shadcn.com/'
		},
		{
			icon: '/about/tailwindcss.svg',
			title: 'Tailwind CSS',
			link: 'https://tailwindcss.com/'
		},
		{
			icon: '/about/framer-motion.svg',
			title: 'Framer Motion',
			link: 'https://www.framer.com/motion/'
		},
		{
			icon: '/about/weatherAPI.svg',
			title: 'Weather API',
	...
	return (
		<>
			...
			<h1 className="text-sm uppercase mt-20 animate-text-appearance delay-500 opacity-0 fill-mode-forwards">
				Сделано с помощью
			</h1>
