...
export default function Home() {
  return (
      <div className="flex h-[100dvh] flex-col items-center justify-center gap-5 animatedTextFirstPage">
          <h1 className={`${megrim.className} text-xl 500p:text-2xl 768p:text-3xl 1024p:text-3xl 4k:text-7xl`}>{name}</h1>
          <p className={`${comfortaa.className} text-[.65rem] text-center 768p:text-sm 1024p:text-sm 4k:text-3xl`}>{description}</p>
      </div>
  )
}
