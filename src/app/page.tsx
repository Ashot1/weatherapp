...
import { comfortaa, megrim } from '@/lib/fonts'
  ...
  return (
      <div className="h-[100dvh] flex flex-col items-center justify-center gap-6">
          <section className="flex gap-5 flex-col items-center justify-center">
              ...
              <p className={`${comfortaa.className} text-xs text-center 768p:text-sm 1024p:text-sm 4k:text-2xl px-1 animate-text-appearance delay-1000 opacity-0 fill-mode-forwards`}>{description}</p>
          </section>
