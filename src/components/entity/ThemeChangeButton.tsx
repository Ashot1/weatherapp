		...
		<Dialog>
			...
			<DialogContent className="max-[550px]:w-[90%]">
				...
				<DialogDescription className="flex flex-col gap-3 mt-3">
					...
					<Separator/>
					<Button onClick={ChangeTheme} value="dark" variant="link" className="w-[100%] justify-start text-xs 768p:text-sm 4k:text-lg"><MoonIcon className="mr-5 4k:w-6 4k:h-6"/>Темная</Button>
					<Separator/>
					<Button onClick={ChangeTheme} value="system" variant="link" className="w-[100%] justify-start text-xs 768p:text-sm 4k:text-lg"><DesktopIcon className="mr-5 4k:w-6 4k:h-6"/>Системная</Button>
				</DialogDescription>
			</DialogContent>
		</Dialog>
	)
